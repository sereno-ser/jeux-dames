    ...
    public static void mouvement(String[][] plateau, int i) {
        ...
        while (boucle) {
            ...
            if (i % 2 != 0) {
                ...
                if ( plateau[ligneo + 1][colonneo - 1] == "\u001B[31mB\u001B[0m" && plateau[ligneo + 1][colonneo + 1] == "\u001B[31mB\u001B[0m" ) {
                    System.out.println("\u001B[31mAttention : aucun mouvement n'est possible rejouez !\u001B[0m");
                    droit = false;

                } else if (plateau[ligneo + 1][colonneo - 1] == "\u001B[34mW\u001B[0m" || plateau[ligneo + 1][colonneo - 1] == "\u001B[34mD\u001B[0m" ) {
                    if (plateau[ligneo + 2][colonneo - 2] != "_") {
                        System.out.println("\u001B[31mAttention : aucun mouvement n'est possible rejouez !\u001B[0m");
                        droit = false;
                    }
                ...
                } else if (plateau[ligneo + 1][colonneo + 1] == ""){
                    if (plateau[ligneo + 1][colonneo - 1] == "\u001B[31mB\u001B[0m" || plateau[ligneo + 1][colonneo - 1] == "\u001B[31mD\u001B[0m") {
                        System.out.println("\u001B[31mAttention : aucun mouvement n'est possible rejouez !\u001B[0m");
                    droit = false;
                    }
                ...
                if ( plateau[ligneo - 1][colonneo - 1] == "\u001B[34mW\u001B[0m" && plateau[ligneo - 1][colonneo + 1] == "\u001B[34mD\u001B[0m" ) {
                    System.out.println("\u001B[31mAttention : aucun mouvement n'est possible rejouez !\u001B[0m");
                    droit = false;

                } else if (plateau[ligneo - 1][colonneo - 1] == "\u001B[31mB\u001B[0m" || plateau[ligneo - 1][colonneo - 1] == "\u001B[31mD\u001B[0m" ) {
                    if (plateau[ligneo - 2][colonneo - 2] != "_") {
                        System.out.println("\u001B[31mAttention : aucun mouvement n'est possible rejouez !\u001B[0m");
                        droit = false;
                    }
                ...
                } else if (plateau[ligneo - 1][colonneo + 1] == "" && plateau[ligneo + 1][colonneo - 1] == "\u001B[31mB\u001B[0m" || plateau[ligneo - 1][colonneo - 1] == "\u001B[31mD\u001B[0m"){
                    System.out.println("\u001B[31mAttention : aucun mouvement n'est possible rejouez !\u001B[0m");
                    droit = false;
